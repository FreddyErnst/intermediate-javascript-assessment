...
String.prototype.grammarPolice = function () {
  let string = this.string.toLowerCase().split(" ")
...
// CODE HERE...
function valueType(param, param1) {
  if (param === param1 && typeof param === typeof param1) {
    return "Exactly the same"
  } else if (param == param1 && typeof param !== typeof param1) {
